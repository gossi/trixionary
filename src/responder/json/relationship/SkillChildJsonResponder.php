...
/**
 * Automatically generated JsonResponder for Reads the relationship of skill to child
 * 
 * @author Thomas Gossmann
 */
class SkillChildJsonResponder extends AbstractPayloadResponder {
	...
	public function updated(Request $request, Updated $payload) {
		...
		$relationship = $serializer->children($payload->getModel());
