...
/**
 * Automatically generated JsonResponder for Reads the relationship of skill to kstruktur_root
 * 
 * @author gossi
 */
class SkillKstrukturRootJsonResponder extends AbstractPayloadResponder {
	...
	public function read(Request $request, Found $payload) {
		...
		$relationship = $serializer->kstrukturRoot($payload->getModel());
