...
/**
 * Automatically generated JsonResponder for Reads the relationship of skill to multiple_of
 * 
 * @author gossi
 */
class SkillMultipleOfJsonResponder extends AbstractPayloadResponder {
	...
	public function read(Request $request, Found $payload) {
		...
		$relationship = $serializer->multipleOf($payload->getModel());
