...
/**
 * Automatically generated JsonResponder for Reads the relationship of generation to generation
 * 
 * @author Thomas Gossmann
 */
class GenerationGenerationJsonResponder extends AbstractPayloadResponder {
	...
	public function read(Request $request, Found $payload) {
		...
		$relationship = $serializer->generation($payload->getModel());
