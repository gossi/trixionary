...
/**
 * Automatically generated JsonResponder for Reads the relationship of skill to skill_version
 * 
 * @author gossi
 */
class SkillSkillVersionJsonResponder extends AbstractPayloadResponder {
	...
	public function updated(Request $request, Updated $payload) {
		...
		$relationship = $serializer->skillVersions($payload->getModel());
