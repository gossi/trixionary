...
/**
 * Automatically generated JsonResponder for Reads the relationship of picture to featured_skill
 * 
 * @author gossi
 */
class PictureFeaturedSkillJsonResponder extends AbstractPayloadResponder {
