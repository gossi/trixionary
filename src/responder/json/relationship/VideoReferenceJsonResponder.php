...
/**
 * Automatically generated JsonResponder for Reads the relationship of video to reference
 * 
 * @author Thomas Gossmann
 */
class VideoReferenceJsonResponder extends AbstractPayloadResponder {
	...
	public function read(Request $request, Found $payload) {
		...
		$relationship = $serializer->reference($payload->getModel());
