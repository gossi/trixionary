...
/**
 * Automatically generated JsonResponder for Reads the relationship of skill to generation
 * 
 * @author Thomas Gossmann
 */
class SkillGenerationJsonResponder extends AbstractPayloadResponder {
	...
	public function updated(Request $request, Updated $payload) {
		...
		$relationship = $serializer->generations($payload->getModel());
