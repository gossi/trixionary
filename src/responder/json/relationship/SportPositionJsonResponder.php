...
/**
 * Automatically generated JsonResponder for Reads the relationship of sport to position
 * 
 * @author Thomas Gossmann
 */
class SportPositionJsonResponder extends AbstractPayloadResponder {
	...
	public function updated(Request $request, Updated $payload) {
		...
		$relationship = $serializer->positions($payload->getModel());
