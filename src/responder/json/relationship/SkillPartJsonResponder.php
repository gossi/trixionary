...
/**
 * Automatically generated JsonResponder for Reads the relationship of skill to part
 * 
 * @author gossi
 */
class SkillPartJsonResponder extends AbstractPayloadResponder {
	...
	public function updated(Request $request, Updated $payload) {
		...
		$relationship = $serializer->parts($payload->getModel());
