...
/**
 * Automatically generated JsonResponder for Reads the relationship of skill to end_position
 * 
 * @author gossi
 */
class SkillEndPositionJsonResponder extends AbstractPayloadResponder {
	...
	public function read(Request $request, Found $payload) {
		...
		$relationship = $serializer->endPosition($payload->getModel());
