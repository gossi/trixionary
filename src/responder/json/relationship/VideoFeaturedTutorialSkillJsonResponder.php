...
/**
 * Automatically generated JsonResponder for Reads the relationship of video to featured_tutorial_skill
 * 
 * @author Thomas Gossmann
 */
class VideoFeaturedTutorialSkillJsonResponder extends AbstractPayloadResponder {
	...
	public function updated(Request $request, Updated $payload) {
		...
		$relationship = $serializer->featuredTutorialSkills($payload->getModel());
