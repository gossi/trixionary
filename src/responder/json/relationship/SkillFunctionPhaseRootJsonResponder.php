...
/**
 * Automatically generated JsonResponder for Reads the relationship of skill to function_phase_root
 * 
 * @author Thomas Gossmann
 */
class SkillFunctionPhaseRootJsonResponder extends AbstractPayloadResponder {
	...
	public function read(Request $request, Found $payload) {
		...
		$relationship = $serializer->functionPhaseRoot($payload->getModel());
