...
/**
 * Automatically generated JsonResponder for Reads the relationship of skill to featured_video
 * 
 * @author Thomas Gossmann
 */
class SkillFeaturedVideoJsonResponder extends AbstractPayloadResponder {
	...
	public function read(Request $request, Found $payload) {
		...
		$relationship = $serializer->featuredVideo($payload->getModel());
