...
/**
 * Automatically generated JsonResponder for Reads the relationship of skill to start_position
 * 
 * @author Thomas Gossmann
 */
class SkillStartPositionJsonResponder extends AbstractPayloadResponder {
	...
	public function read(Request $request, Found $payload) {
		...
		$relationship = $serializer->startPosition($payload->getModel());
