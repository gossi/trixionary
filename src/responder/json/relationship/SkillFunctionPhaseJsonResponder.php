...
/**
 * Automatically generated JsonResponder for Reads the relationship of skill to function_phase
 * 
 * @author gossi
 */
class SkillFunctionPhaseJsonResponder extends AbstractPayloadResponder {
	...
	public function updated(Request $request, Updated $payload) {
		...
		$relationship = $serializer->functionPhases($payload->getModel());
