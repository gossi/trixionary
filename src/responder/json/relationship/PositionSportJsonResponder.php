...
/**
 * Automatically generated JsonResponder for Reads the relationship of position to sport
 * 
 * @author gossi
 */
class PositionSportJsonResponder extends AbstractPayloadResponder {
	...
	public function read(Request $request, Found $payload) {
		...
		$relationship = $serializer->sport($payload->getModel());
