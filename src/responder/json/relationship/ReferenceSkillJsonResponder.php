...
/**
 * Automatically generated JsonResponder for Reads the relationship of reference to skill
 * 
 * @author Thomas Gossmann
 */
class ReferenceSkillJsonResponder extends AbstractPayloadResponder {
	...
	public function updated(Request $request, Updated $payload) {
		...
		$relationship = $serializer->skills($payload->getModel());
