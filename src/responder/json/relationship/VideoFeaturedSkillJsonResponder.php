...
/**
 * Automatically generated JsonResponder for Reads the relationship of video to featured_skill
 * 
 * @author Thomas Gossmann
 */
class VideoFeaturedSkillJsonResponder extends AbstractPayloadResponder {
	...
	public function updated(Request $request, Updated $payload) {
		...
		$relationship = $serializer->featuredSkills($payload->getModel());
