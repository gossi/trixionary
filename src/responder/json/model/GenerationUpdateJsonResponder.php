...
use gossi\trixionary\model\Generation;
...
/**
 * Automatically generated JsonResponder for Updates a generation
 * 
 * @author Thomas Gossmann
 */
class GenerationUpdateJsonResponder extends AbstractPayloadResponder {
	...
	public function updated(Request $request, Updated $payload) {
		...
		$serializer = Generation::getSerializer();
		$resource = new Resource($payload->getModel(), $serializer);
		$resource = $resource->with($params->getInclude(['skill', 'generation']));
		$resource = $resource->fields($params->getFields([
			'generation' => Skill::getSerializer()->getFields(),
