...
class FunctionPhaseTableMap extends TableMap
{
     ...
     */
    const COL_PARENT_ID = 'kk_trixionary_function_phase.parent_id';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(FunctionPhaseTableMap::COL_ID, FunctionPhaseTableMap::COL_TYPE, FunctionPhaseTableMap::COL_SKILL_ID, FunctionPhaseTableMap::COL_TITLE, FunctionPhaseTableMap::COL_PARENT_ID, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(FunctionPhaseTableMap::COL_ID => 0, FunctionPhaseTableMap::COL_TYPE => 1, FunctionPhaseTableMap::COL_SKILL_ID => 2, FunctionPhaseTableMap::COL_TITLE => 3, FunctionPhaseTableMap::COL_PARENT_ID => 4, ),
    ...
    public function initialize()
    {
        ...
        $this->addForeignKey('parent_id', 'ParentId', 'INTEGER', 'kk_trixionary_function_phase', 'id', false, null, null);
    } // initialize()
    ...
    public function buildRelations()
    {
        ...
        $this->addRelation('Parent', '\\gossi\\trixionary\\model\\FunctionPhase', RelationMap::MANY_TO_ONE, array('parent_id' => 'id', ), 'CASCADE', null);
        $this->addRelation('Children', '\\gossi\\trixionary\\model\\FunctionPhase', RelationMap::ONE_TO_MANY, array('id' => 'parent_id', ), 'CASCADE', null, 'Childrens');
    } // buildRelations()
    /**
     * Method to invalidate the instance pool of all tables related to kk_trixionary_function_phase     * by a foreign key with ON DELETE CASCADE
     */
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(FunctionPhaseTableMap::COL_PARENT_ID);
        } else {
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria->containsKey(FunctionPhaseTableMap::COL_ID) && $criteria->keyContainsValue(FunctionPhaseTableMap::COL_ID) ) {
