...
/**
 * This class defines the structure of the 'kk_trixionary_skill_dependency' table.
 *
 *
 *
 ...
 *
 */
class SkillDependencyTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = '.Map.SkillDependencyTableMap';
     ...
     */
    const TABLE_NAME = 'kk_trixionary_skill_dependency';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\gossi\\trixionary\\model\\SkillDependency';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'SkillDependency';
    ...
    {
        // attributes
        $this->setName('kk_trixionary_skill_dependency');
        $this->setPhpName('SkillDependency');
        $this->setIdentifierQuoting(true);
        $this->setClassName('\\gossi\\trixionary\\model\\SkillDependency');
        $this->setPackage('');
  ...
  array (
     ...
     * and findPk*() calls.
     *
     * @param \gossi\trixionary\model\SkillDependency $obj A \gossi\trixionary\model\SkillDependency object.
     ...
     *
     * @param mixed $value A \gossi\trixionary\model\SkillDependency object or a primary key value.
     */
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && null !== $value) {
            if (is_object($value) && $value instanceof \gossi\trixionary\model\SkillDependency) {
                ...
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or \gossi\trixionary\model\SkillDependency object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value, true)));
                throw $e;
            }
    ...
    {
        return $withPrefix ? SkillDependencyTableMap::CLASS_DEFAULT : SkillDependencyTableMap::OM_CLASS;
    }
     ...
     * @return array           (SkillDependency object, last column rank)
     */
    public static function populateObject($row, $offset = 0, $indexType = TableMap::TYPE_NUM)
    {
        $key = SkillDependencyTableMap::getPrimaryKeyHashFromRow($row, $offset, $indexType);
        if (null !== ($obj = SkillDependencyTableMap::getInstanceFromPool($key))) {
            // We no longer rehydrate the object, since this can cause data loss.
            // See http://www.propelorm.org/ticket/509
            // $obj->hydrate($row, $offset, true); // rehydrate
            $col = $offset + SkillDependencyTableMap::NUM_HYDRATE_COLUMNS;
        } else {
            $cls = SkillDependencyTableMap::OM_CLASS;
            /** @var SkillDependency $obj */
            $obj = new $cls();
            $col = $obj->hydrate($row, $offset, false, $indexType);
            SkillDependencyTableMap::addInstanceToPool($obj, $key);
        }
    ...
    public static function populateObjects(DataFetcherInterface $dataFetcher)
    {
        ...
        while ($row = $dataFetcher->fetch()) {
            $key = SkillDependencyTableMap::getPrimaryKeyHashFromRow($row, 0, $dataFetcher->getIndexType());
            if (null !== ($obj = SkillDependencyTableMap::getInstanceFromPool($key))) {
                // We no longer rehydrate the object, since this can cause data loss.
                // See http://www.propelorm.org/ticket/509
    ...
    {
        return Propel::getServiceContainer()->getDatabaseMap(SkillDependencyTableMap::DATABASE_NAME)->getTable(SkillDependencyTableMap::TABLE_NAME);
    }
    ...
    {
        $dbMap = Propel::getServiceContainer()->getDatabaseMap(SkillDependencyTableMap::DATABASE_NAME);
        if (!$dbMap->hasTable(SkillDependencyTableMap::TABLE_NAME)) {
            $dbMap->addTableObject(new SkillDependencyTableMap());
        }
    }

    /**
     * Performs a DELETE on the database, given a SkillDependency or Criteria object OR a primary key value.
     *
     * @param mixed               $values Criteria or SkillDependency object or primary key or array of primary keys
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \gossi\trixionary\model\SkillDependency) { // it's a model object
        ...
        if ($values instanceof Criteria) {
            ...
            foreach ((array) $values as $singleval) {
                SkillDependencyTableMap::removeInstanceFromPool($singleval);
            }
        }
    ...
    {
        return SkillDependencyQuery::create()->doDeleteAll($con);
    }
...
//
SkillDependencyTableMap::buildTableMap();
