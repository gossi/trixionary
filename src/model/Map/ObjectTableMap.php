...
/**
 * This class defines the structure of the 'kk_trixionary_object' table.
 *
 *
 *
...
class ObjectTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = '.Map.ObjectTableMap';
     ...
     */
    const TABLE_NAME = 'kk_trixionary_object';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\gossi\\trixionary\\model\\Object';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Object';
     ...
     */
    const COL_ID = 'kk_trixionary_object.id';

    /**
     * the column name for the title field
     */
    const COL_TITLE = 'kk_trixionary_object.title';

    /**
     * the column name for the slug field
     */
    const COL_SLUG = 'kk_trixionary_object.slug';

    /**
     * the column name for the fixed field
     */
    const COL_FIXED = 'kk_trixionary_object.fixed';

    /**
     * the column name for the description field
     */
    const COL_DESCRIPTION = 'kk_trixionary_object.description';
    ...
    {
        // attributes
        $this->setName('kk_trixionary_object');
        $this->setPhpName('Object');
        $this->setIdentifierQuoting(true);
        $this->setClassName('\\gossi\\trixionary\\model\\Object');
        $this->setPackage('');
  ...
  array (
    ...
    {
        return $withPrefix ? ObjectTableMap::CLASS_DEFAULT : ObjectTableMap::OM_CLASS;
    }
     ...
     * @return array           (Object object, last column rank)
     */
    public static function populateObject($row, $offset = 0, $indexType = TableMap::TYPE_NUM)
    {
        $key = ObjectTableMap::getPrimaryKeyHashFromRow($row, $offset, $indexType);
        if (null !== ($obj = ObjectTableMap::getInstanceFromPool($key))) {
            // We no longer rehydrate the object, since this can cause data loss.
            // See http://www.propelorm.org/ticket/509
            // $obj->hydrate($row, $offset, true); // rehydrate
            $col = $offset + ObjectTableMap::NUM_HYDRATE_COLUMNS;
        } else {
            $cls = ObjectTableMap::OM_CLASS;
            /** @var Object $obj */
            $obj = new $cls();
            $col = $obj->hydrate($row, $offset, false, $indexType);
            ObjectTableMap::addInstanceToPool($obj, $key);
        }
    ...
    public static function populateObjects(DataFetcherInterface $dataFetcher)
    {
        ...
        while ($row = $dataFetcher->fetch()) {
            $key = ObjectTableMap::getPrimaryKeyHashFromRow($row, 0, $dataFetcher->getIndexType());
            if (null !== ($obj = ObjectTableMap::getInstanceFromPool($key))) {
                // We no longer rehydrate the object, since this can cause data loss.
                // See http://www.propelorm.org/ticket/509
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(ObjectTableMap::COL_ID);
            $criteria->addSelectColumn(ObjectTableMap::COL_TITLE);
            $criteria->addSelectColumn(ObjectTableMap::COL_SLUG);
    ...
    {
        return Propel::getServiceContainer()->getDatabaseMap(ObjectTableMap::DATABASE_NAME)->getTable(ObjectTableMap::TABLE_NAME);
    }
    ...
    {
        $dbMap = Propel::getServiceContainer()->getDatabaseMap(ObjectTableMap::DATABASE_NAME);
        if (!$dbMap->hasTable(ObjectTableMap::TABLE_NAME)) {
            $dbMap->addTableObject(new ObjectTableMap());
        }
    }

    /**
     * Performs a DELETE on the database, given a Object or Criteria object OR a primary key value.
     *
     * @param mixed               $values Criteria or Object object or primary key or array of primary keys
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \gossi\trixionary\model\Object) { // it's a model object
            // create criteria based on pk values
            $criteria = $values->buildPkeyCriteria();
        } else { // it's a primary key, or an array of pks
            $criteria = new Criteria(ObjectTableMap::DATABASE_NAME);
            $criteria->add(ObjectTableMap::COL_ID, (array) $values, Criteria::IN);
        }
        ...
        if ($values instanceof Criteria) {
            ...
            foreach ((array) $values as $singleval) {
                ObjectTableMap::removeInstanceFromPool($singleval);
            }
        }
    ...
    {
        return ObjectQuery::create()->doDeleteAll($con);
    }
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria instanceof Criteria) {
            ...
            $criteria = $criteria->buildCriteria(); // build Criteria from Object object
        }
