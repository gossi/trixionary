...
/**
 * This class defines the structure of the 'kk_trixionary_skill_part' table.
 *
 *
 *
 ...
 *
 */
class SkillPartTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = '.Map.SkillPartTableMap';
     ...
     */
    const TABLE_NAME = 'kk_trixionary_skill_part';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\gossi\\trixionary\\model\\SkillPart';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'SkillPart';
    ...
    {
        // attributes
        $this->setName('kk_trixionary_skill_part');
        $this->setPhpName('SkillPart');
        $this->setIdentifierQuoting(true);
        $this->setClassName('\\gossi\\trixionary\\model\\SkillPart');
        $this->setPackage('');
  ...
  array (
     ...
     *
     * @param mixed $value A \gossi\trixionary\model\SkillPart object or a primary key value.
     */
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && null !== $value) {
            if (is_object($value) && $value instanceof \gossi\trixionary\model\SkillPart) {
                ...
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or \gossi\trixionary\model\SkillPart object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value, true)));
                throw $e;
            }
    ...
    {
        return $withPrefix ? SkillPartTableMap::CLASS_DEFAULT : SkillPartTableMap::OM_CLASS;
    }
     ...
     * @return array           (SkillPart object, last column rank)
     */
    public static function populateObject($row, $offset = 0, $indexType = TableMap::TYPE_NUM)
    {
        $key = SkillPartTableMap::getPrimaryKeyHashFromRow($row, $offset, $indexType);
        if (null !== ($obj = SkillPartTableMap::getInstanceFromPool($key))) {
            // We no longer rehydrate the object, since this can cause data loss.
            // See http://www.propelorm.org/ticket/509
            // $obj->hydrate($row, $offset, true); // rehydrate
            $col = $offset + SkillPartTableMap::NUM_HYDRATE_COLUMNS;
        } else {
            $cls = SkillPartTableMap::OM_CLASS;
            /** @var SkillPart $obj */
            $obj = new $cls();
            $col = $obj->hydrate($row, $offset, false, $indexType);
            SkillPartTableMap::addInstanceToPool($obj, $key);
        }
    ...
    public static function populateObjects(DataFetcherInterface $dataFetcher)
    {
        ...
        while ($row = $dataFetcher->fetch()) {
            $key = SkillPartTableMap::getPrimaryKeyHashFromRow($row, 0, $dataFetcher->getIndexType());
            if (null !== ($obj = SkillPartTableMap::getInstanceFromPool($key))) {
                // We no longer rehydrate the object, since this can cause data loss.
                // See http://www.propelorm.org/ticket/509
    ...
    {
        return Propel::getServiceContainer()->getDatabaseMap(SkillPartTableMap::DATABASE_NAME)->getTable(SkillPartTableMap::TABLE_NAME);
    }
    ...
    {
        $dbMap = Propel::getServiceContainer()->getDatabaseMap(SkillPartTableMap::DATABASE_NAME);
        if (!$dbMap->hasTable(SkillPartTableMap::TABLE_NAME)) {
            $dbMap->addTableObject(new SkillPartTableMap());
        }
    }
     ...
     *
     * @param mixed               $values Criteria or SkillPart object or primary key or array of primary keys
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \gossi\trixionary\model\SkillPart) { // it's a model object
        ...
        $query = SkillPartQuery::create()->mergeWith($criteria);

        if ($values instanceof Criteria) {
            SkillPartTableMap::clearInstancePool();
        } elseif (!is_object($values)) { // it's a primary key, or an array of pks
            foreach ((array) $values as $singleval) {
                SkillPartTableMap::removeInstanceFromPool($singleval);
            }
        }
    ...
    {
        return SkillPartQuery::create()->doDeleteAll($con);
    }

    /**
     * Performs an INSERT on the database, given a SkillPart or Criteria object.
     *
     * @param mixed               $criteria Criteria or SkillPart object containing data that is used to create the INSERT statement.
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria instanceof Criteria) {
            ...
            $criteria = $criteria->buildCriteria(); // build Criteria from SkillPart object
        }
...
//
SkillPartTableMap::buildTableMap();
