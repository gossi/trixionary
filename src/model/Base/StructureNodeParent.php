...
/**
 * Base class that represents a row from the 'kk_trixionary_structure_node_parent' table.
 *
 *
 *
* @package    propel.generator..Base
*/
abstract class StructureNodeParent implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\gossi\\trixionary\\model\\Map\\StructureNodeParentTableMap';
     ...
     * @var        ChildStructureNode
     */
    protected $aStructureNodeRelatedByParentId;
    ...
    /**
     * Initializes internal state of gossi\trixionary\model\Base\StructureNodeParent object.
     */
    ...
    /**
     * Compares this with another <code>StructureNodeParent</code> instance.  If
     * <code>obj</code> is an instance of <code>StructureNodeParent</code>, delegates to
     * <code>equals(StructureNodeParent)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|StructureNodeParent The current object, for fluid interface
     */
    ...
    public function setParentId($v)
    {
        ...
        if ($this->parent_id !== $v) {
            $this->parent_id = $v;
            $this->modifiedColumns[StructureNodeParentTableMap::COL_PARENT_ID] = true;
        }

        if ($this->aStructureNodeRelatedByParentId !== null && $this->aStructureNodeRelatedByParentId->getId() !== $v) {
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            return $startcol + 2; // 2 = StructureNodeParentTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\gossi\\trixionary\\model\\StructureNodeParent'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildStructureNodeParentQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see StructureNodeParent::setDeleted()
     * @see StructureNodeParent::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildStructureNodeParentQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                StructureNodeParentTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doSave(ConnectionInterface $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->aStructureNodeRelatedByParentId !== null) {
                if ($this->aStructureNodeRelatedByParentId->isModified() || $this->aStructureNodeRelatedByParentId->isNew()) {
                    $affectedRows += $this->aStructureNodeRelatedByParentId->save($con);
                }
                $this->setStructureNodeRelatedByParentId($this->aStructureNodeRelatedByParentId);
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $sql = sprintf(
            'INSERT INTO `kk_trixionary_structure_node_parent` (%s) VALUES (%s)',
    ...
    {
        $pos = StructureNodeParentTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['StructureNodeParent'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        ...
        if ($includeForeignObjects) {
            ...
            if (null !== $this->aStructureNodeRelatedByParentId) {
                ...
                $result[$key] = $this->aStructureNodeRelatedByParentId->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
        }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\gossi\trixionary\model\StructureNodeParent
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\gossi\trixionary\model\StructureNodeParent The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \gossi\trixionary\model\StructureNodeParent (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \gossi\trixionary\model\StructureNodeParent Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(StructureNodeParentTableMap::DEFAULT_STRING_FORMAT);
    }
