...
/**
 * Base class that represents a row from the 'kk_trixionary_skill_group' table.
 *
 *
 *
* @package    propel.generator..Base
*/
abstract class SkillGroup implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\gossi\\trixionary\\model\\Map\\SkillGroupTableMap';
    ...
    /**
     * Compares this with another <code>SkillGroup</code> instance.  If
     * <code>obj</code> is an instance of <code>SkillGroup</code>, delegates to
     * <code>equals(SkillGroup)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|SkillGroup The current object, for fluid interface
     */
    ...
    public function setSkillId($v)
    {
        ...
        if ($this->skill_id !== $v) {
            $this->skill_id = $v;
            $this->modifiedColumns[SkillGroupTableMap::COL_SKILL_ID] = true;
        }
    ...
    public function setGroupId($v)
    {
        ...
        if ($this->group_id !== $v) {
            $this->group_id = $v;
            $this->modifiedColumns[SkillGroupTableMap::COL_GROUP_ID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : SkillGroupTableMap::translateFieldName('SkillId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->skill_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : SkillGroupTableMap::translateFieldName('GroupId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 2; // 2 = SkillGroupTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\gossi\\trixionary\\model\\SkillGroup'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildSkillGroupQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see SkillGroup::setDeleted()
     * @see SkillGroup::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildSkillGroupQuery::create()
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(SkillGroupTableMap::COL_SKILL_ID)) {
            $modifiedColumns[':p' . $index++]  = '`skill_id`';
        }
        if ($this->isColumnModified(SkillGroupTableMap::COL_GROUP_ID)) {
            $modifiedColumns[':p' . $index++]  = '`group_id`';
        }

        $sql = sprintf(
            'INSERT INTO `kk_trixionary_skill_group` (%s) VALUES (%s)',
    ...
    {
        $pos = SkillGroupTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['SkillGroup'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['SkillGroup'][$this->hashCode()] = true;
        $keys = SkillGroupTableMap::getFieldNames($keyType);
        $result = array(
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\gossi\trixionary\model\SkillGroup
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\gossi\trixionary\model\SkillGroup The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(SkillGroupTableMap::COL_SKILL_ID)) {
            $criteria->add(SkillGroupTableMap::COL_SKILL_ID, $this->skill_id);
        }
        if ($this->isColumnModified(SkillGroupTableMap::COL_GROUP_ID)) {
            $criteria->add(SkillGroupTableMap::COL_GROUP_ID, $this->group_id);
        }
    ...
    {
        $criteria = ChildSkillGroupQuery::create();
        $criteria->add(SkillGroupTableMap::COL_SKILL_ID, $this->skill_id);
        $criteria->add(SkillGroupTableMap::COL_GROUP_ID, $this->group_id);
    ...
    {
        return (null === $this->getSkillId()) && (null === $this->getGroupId());
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \gossi\trixionary\model\SkillGroup (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \gossi\trixionary\model\SkillGroup Clone of current object.
     * @throws PropelException
     */
    ...
    public function getSkill(ConnectionInterface $con = null)
    {
        if ($this->aSkill === null && ($this->skill_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aSkill->addSkillGroups($this);
             */
        }
    ...
    {
        if (null !== $this->aGroup) {
            $this->aGroup->removeSkillGroup($this);
        }
        if (null !== $this->aSkill) {
            $this->aSkill->removeSkillGroup($this);
        }
        $this->skill_id = null;
        $this->group_id = null;
        $this->alreadyInSave = false;
