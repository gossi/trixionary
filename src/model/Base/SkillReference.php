...
/**
 * Base class that represents a row from the 'kk_trixionary_skill_reference' table.
 *
 *
 *
* @package    propel.generator..Base
*/
abstract class SkillReference implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\gossi\\trixionary\\model\\Map\\SkillReferenceTableMap';
    ...
    /**
     * Initializes internal state of gossi\trixionary\model\Base\SkillReference object.
     */
    ...
    /**
     * Compares this with another <code>SkillReference</code> instance.  If
     * <code>obj</code> is an instance of <code>SkillReference</code>, delegates to
     * <code>equals(SkillReference)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|SkillReference The current object, for fluid interface
     */
    ...
    public function setSkillId($v)
    {
        ...
        if ($this->skill_id !== $v) {
            $this->skill_id = $v;
            $this->modifiedColumns[SkillReferenceTableMap::COL_SKILL_ID] = true;
        }
    ...
    public function setReferenceId($v)
    {
        ...
        if ($this->reference_id !== $v) {
            $this->reference_id = $v;
            $this->modifiedColumns[SkillReferenceTableMap::COL_REFERENCE_ID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : SkillReferenceTableMap::translateFieldName('SkillId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->skill_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : SkillReferenceTableMap::translateFieldName('ReferenceId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 2; // 2 = SkillReferenceTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\gossi\\trixionary\\model\\SkillReference'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildSkillReferenceQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see SkillReference::setDeleted()
     * @see SkillReference::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildSkillReferenceQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                SkillReferenceTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(SkillReferenceTableMap::COL_SKILL_ID)) {
            $modifiedColumns[':p' . $index++]  = '`skill_id`';
        }
        if ($this->isColumnModified(SkillReferenceTableMap::COL_REFERENCE_ID)) {
            $modifiedColumns[':p' . $index++]  = '`reference_id`';
        }

        $sql = sprintf(
            'INSERT INTO `kk_trixionary_skill_reference` (%s) VALUES (%s)',
    ...
    {
        $pos = SkillReferenceTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\gossi\trixionary\model\SkillReference
     */
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) {
            $this->setReferenceId($arr[$keys[1]]);
        }
    }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\gossi\trixionary\model\SkillReference The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(SkillReferenceTableMap::COL_SKILL_ID)) {
            $criteria->add(SkillReferenceTableMap::COL_SKILL_ID, $this->skill_id);
        }
        if ($this->isColumnModified(SkillReferenceTableMap::COL_REFERENCE_ID)) {
            $criteria->add(SkillReferenceTableMap::COL_REFERENCE_ID, $this->reference_id);
        }
    ...
    {
        $criteria = ChildSkillReferenceQuery::create();
        $criteria->add(SkillReferenceTableMap::COL_SKILL_ID, $this->skill_id);
        $criteria->add(SkillReferenceTableMap::COL_REFERENCE_ID, $this->reference_id);
    ...
    public function hashCode()
    {
        $validPk = null !== $this->getSkillId() &&
            null !== $this->getReferenceId();

        $validPrimaryKeyFKs = 2;
        $primaryKeyFKs = [];

        //relation skill_reference_fk_skill to table kk_trixionary_skill
        ...
        //relation skill_reference_fk_reference to table kk_trixionary_reference
        if ($this->aReference && $hash = spl_object_hash($this->aReference)) {
            $primaryKeyFKs[] = $hash;
        } else {
            $validPrimaryKeyFKs = false;
        }
    ...
    {
        return (null === $this->getSkillId()) && (null === $this->getReferenceId());
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \gossi\trixionary\model\SkillReference (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \gossi\trixionary\model\SkillReference Clone of current object.
     * @throws PropelException
     */
    ...
    public function getReference(ConnectionInterface $con = null)
    {
        if ($this->aReference === null && ($this->reference_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aReference->addSkillReferences($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(SkillReferenceTableMap::DEFAULT_STRING_FORMAT);
    }
