...
/**
 * Base class that represents a row from the 'kk_trixionary_skill_dependency' table.
 *
 *
 *
* @package    propel.generator..Base
*/
abstract class SkillDependency implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\gossi\\trixionary\\model\\Map\\SkillDependencyTableMap';
    ...
    /**
     * Initializes internal state of gossi\trixionary\model\Base\SkillDependency object.
     */
    ...
    /**
     * Compares this with another <code>SkillDependency</code> instance.  If
     * <code>obj</code> is an instance of <code>SkillDependency</code>, delegates to
     * <code>equals(SkillDependency)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|SkillDependency The current object, for fluid interface
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            return $startcol + 2; // 2 = SkillDependencyTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\gossi\\trixionary\\model\\SkillDependency'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildSkillDependencyQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see SkillDependency::setDeleted()
     * @see SkillDependency::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildSkillDependencyQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                SkillDependencyTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $sql = sprintf(
            'INSERT INTO `kk_trixionary_skill_dependency` (%s) VALUES (%s)',
    ...
    {
        $pos = SkillDependencyTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['SkillDependency'][$this->hashCode()])) {
            return '*RECURSION*';
        }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\gossi\trixionary\model\SkillDependency
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\gossi\trixionary\model\SkillDependency The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \gossi\trixionary\model\SkillDependency (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \gossi\trixionary\model\SkillDependency Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(SkillDependencyTableMap::DEFAULT_STRING_FORMAT);
    }
