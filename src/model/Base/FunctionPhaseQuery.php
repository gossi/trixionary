...
/**
 * Base class that represents a query for the 'kk_trixionary_function_phase' table.
 *
 *
 *
 * @method     ChildFunctionPhaseQuery orderById($order = Criteria::ASC) Order by the id column
...
abstract class FunctionPhaseQuery extends ChildStructureNodeQuery
{
     ...
     */
    public function __construct($dbName = 'keeko', $modelName = '\\gossi\\trixionary\\model\\FunctionPhase', $modelAlias = null)
    {
        parent::__construct($dbName, $modelName, $modelAlias);
    }

    /**
     * Returns a new ChildFunctionPhaseQuery object.
     *
     * @param     string $modelAlias The alias of a model in the query
     * @param     Criteria $criteria Optional Criteria to build the query from
     *
     * @return ChildFunctionPhaseQuery
     */
    public static function create($modelAlias = null, Criteria $criteria = null)
    {
        if ($criteria instanceof ChildFunctionPhaseQuery) {
            return $criteria;
        }
        $query = new ChildFunctionPhaseQuery();
        if (null !== $modelAlias) {
     ...
     *
     * @return ChildFunctionPhase|array|mixed the result, formatted by the current formatter
     */
    public function findPk($key, ConnectionInterface $con = null)
    {
        ...
        if ((null !== ($obj = FunctionPhaseTableMap::getInstanceFromPool((string) $key))) && !$this->formatter) {
     ...
     *
     * @return ChildFunctionPhase A model object, or null if the key is not found
     */
    protected function findPkSimple($key, ConnectionInterface $con)
    {
        ...
        if ($row = $stmt->fetch(\PDO::FETCH_NUM)) {
            /** @var ChildFunctionPhase $obj */
            $obj = new ChildFunctionPhase();
            $obj->hydrate($row);
            FunctionPhaseTableMap::addInstanceToPool($obj, (string) $key);
        }
        $stmt->closeCursor();
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        return $this->addUsingAlias(FunctionPhaseTableMap::COL_ID, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(FunctionPhaseTableMap::COL_ID, $keys, Criteria::IN);
    }
    ...
    public function filterById($id = null, $comparison = null)
    {
        if (is_array($id)) {
            $useMinMax = false;
            if (isset($id['min'])) {
                $this->addUsingAlias(FunctionPhaseTableMap::COL_ID, $id['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($id['max'])) {
                $this->addUsingAlias(FunctionPhaseTableMap::COL_ID, $id['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(FunctionPhaseTableMap::COL_ID, $id, $comparison);
    }
    ...
    public function filterByType($type = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(FunctionPhaseTableMap::COL_TYPE, $type, $comparison);
    }
    ...
    public function filterBySkillId($skillId = null, $comparison = null)
    {
        if (is_array($skillId)) {
            ...
            if (isset($skillId['min'])) {
                $this->addUsingAlias(FunctionPhaseTableMap::COL_SKILL_ID, $skillId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($skillId['max'])) {
                $this->addUsingAlias(FunctionPhaseTableMap::COL_SKILL_ID, $skillId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(FunctionPhaseTableMap::COL_SKILL_ID, $skillId, $comparison);
    }
    ...
    public function filterByTitle($title = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(FunctionPhaseTableMap::COL_TITLE, $title, $comparison);
    }
    ...
    public function filterBySkillRelatedBySkillId($skill, $comparison = null)
    {
        if ($skill instanceof \gossi\trixionary\model\Skill) {
            return $this
                ->addUsingAlias(FunctionPhaseTableMap::COL_SKILL_ID, $skill->getId(), $comparison);
    ...
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $criteria->setDbName(FunctionPhaseTableMap::DATABASE_NAME);
        ...
        return $con->transaction(function () use ($con, $criteria) {
            ...
            FunctionPhaseTableMap::removeInstanceFromPool($criteria);
