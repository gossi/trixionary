...
*/
abstract class Kstruktur extends ChildStructureNode implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            return $startcol + 4; // 4 = KstrukturTableMap::NUM_HYDRATE_COLUMNS.
    ...
    public function hashCode()
    {
        ...
        //relation kk_trixionary_kstruktur_fk_d85fca to table kk_trixionary_structure_node
    ...
    public function getStructureNode(ConnectionInterface $con = null)
    {
        if ($this->aStructureNode === null && ($this->id !== null)) {
            ...
            $this->aStructureNode->setKstruktur($this);
        }
    ...
    public function setSkillRelatedBySkillId(ChildSkill $v = null)
    {
        ...
        if ($v !== null) {
            $v->addKstrukturRelatedBySkillId($this);
        }
    ...
    public function getSkillRelatedBySkillId(ConnectionInterface $con = null)
    {
        if ($this->aSkillRelatedBySkillId === null && ($this->skill_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aSkillRelatedBySkillId->addKstruktursRelatedBySkillId($this);
             */
        }
    ...
    public function setRootSkills(Collection $rootSkills, ConnectionInterface $con = null)
    {
        ...
        foreach ($rootSkillsToDelete as $rootSkillRemoved) {
            $rootSkillRemoved->setKstrukturRoot(null);
        }
    ...
    protected function doAddRootSkill(ChildSkill $rootSkill)
    {
        ...
        $rootSkill->setKstrukturRoot($this);
    }
     ...
     * @return ObjectCollection|ChildSkill[] List of ChildSkill objects
     */
    public function getRootSkillsJoinFeaturedVideo(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildSkillQuery::create(null, $criteria);
     ...
     * @return ObjectCollection|ChildSkill[] List of ChildSkill objects
     */
    public function getRootSkillsJoinFeaturedTutorial(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildSkillQuery::create(null, $criteria);
