...
/**
 * Base class that represents a row from the 'kk_trixionary_kstruktur' table.
 *
 *
 *
* @package    propel.generator..Base
*/
abstract class Kstruktur implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\gossi\\trixionary\\model\\Map\\KstrukturTableMap';
    ...
    /**
     * Initializes internal state of gossi\trixionary\model\Base\Kstruktur object.
     */
    ...
    /**
     * Compares this with another <code>Kstruktur</code> instance.  If
     * <code>obj</code> is an instance of <code>Kstruktur</code>, delegates to
     * <code>equals(Kstruktur)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Kstruktur The current object, for fluid interface
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[KstrukturTableMap::COL_ID] = true;
        }
    ...
    public function setType($v)
    {
        ...
        if ($this->type !== $v) {
            $this->type = $v;
            $this->modifiedColumns[KstrukturTableMap::COL_TYPE] = true;
        }
    ...
    public function setSkillId($v)
    {
        ...
        if ($this->skill_id !== $v) {
            $this->skill_id = $v;
            $this->modifiedColumns[KstrukturTableMap::COL_SKILL_ID] = true;
        }
    ...
    public function setTitle($v)
    {
        ...
        if ($this->title !== $v) {
            $this->title = $v;
            $this->modifiedColumns[KstrukturTableMap::COL_TITLE] = true;
        }
    ...
    public function setParentId($v)
    {
        ...
        if ($this->parent_id !== $v) {
            $this->parent_id = $v;
            $this->modifiedColumns[KstrukturTableMap::COL_PARENT_ID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : KstrukturTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : KstrukturTableMap::translateFieldName('Type', TableMap::TYPE_PHPNAME, $indexType)];
            $this->type = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : KstrukturTableMap::translateFieldName('SkillId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->skill_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : KstrukturTableMap::translateFieldName('Title', TableMap::TYPE_PHPNAME, $indexType)];
            $this->title = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : KstrukturTableMap::translateFieldName('ParentId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 5; // 5 = KstrukturTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\gossi\\trixionary\\model\\Kstruktur'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildKstrukturQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Kstruktur::setDeleted()
     * @see Kstruktur::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildKstrukturQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                KstrukturTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(KstrukturTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(KstrukturTableMap::COL_TYPE)) {
            $modifiedColumns[':p' . $index++]  = '`type`';
        }
        if ($this->isColumnModified(KstrukturTableMap::COL_SKILL_ID)) {
            $modifiedColumns[':p' . $index++]  = '`skill_id`';
        }
        if ($this->isColumnModified(KstrukturTableMap::COL_TITLE)) {
            $modifiedColumns[':p' . $index++]  = '`title`';
        }
        if ($this->isColumnModified(KstrukturTableMap::COL_PARENT_ID)) {
            $modifiedColumns[':p' . $index++]  = '`parent_id`';
        }

        $sql = sprintf(
            'INSERT INTO `kk_trixionary_kstruktur` (%s) VALUES (%s)',
    ...
    {
        $pos = KstrukturTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\gossi\trixionary\model\Kstruktur
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\gossi\trixionary\model\Kstruktur The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(KstrukturTableMap::COL_TYPE)) {
            $criteria->add(KstrukturTableMap::COL_TYPE, $this->type);
        }
        if ($this->isColumnModified(KstrukturTableMap::COL_SKILL_ID)) {
            $criteria->add(KstrukturTableMap::COL_SKILL_ID, $this->skill_id);
        }
        if ($this->isColumnModified(KstrukturTableMap::COL_TITLE)) {
            $criteria->add(KstrukturTableMap::COL_TITLE, $this->title);
        }
        if ($this->isColumnModified(KstrukturTableMap::COL_PARENT_ID)) {
            $criteria->add(KstrukturTableMap::COL_PARENT_ID, $this->parent_id);
        }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \gossi\trixionary\model\Kstruktur (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \gossi\trixionary\model\Kstruktur Clone of current object.
     * @throws PropelException
     */
    ...
    public function getSkill(ConnectionInterface $con = null)
    {
        if ($this->aSkill === null && ($this->skill_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aSkill->addKstrukturs($this);
             */
        }
     ...
     * @throws PropelException
     */
    public function setParent(ChildKstruktur $v = null)
    {
        if ($v === null) {
    ...
    public function getParent(ConnectionInterface $con = null)
    {
        if ($this->aParent === null && ($this->parent_id !== null)) {
            $this->aParent = ChildKstrukturQuery::create()->findPk($this->parent_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
    ...
    public function initChildrens($overrideExisting = true)
    {
        ...
        $this->collChildrens->setModel('\gossi\trixionary\model\Kstruktur');
    }
     ...
     * If this ChildKstruktur is new, it will return
    ...
    public function getChildrens(Criteria $criteria = null, ConnectionInterface $con = null)
    {
        ...
        if (null === $this->collChildrens || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collChildrens) {
                ...
                $collChildrens = ChildKstrukturQuery::create(null, $criteria)
                    ->filterByParent($this)
                    ->find($con);
    ...
    {
        /** @var ChildKstruktur[] $childrensToDelete */
     ...
     * @return $this|\gossi\trixionary\model\Kstruktur The current object (for fluent API support)
     */
    public function addChildren(ChildKstruktur $l)
    {
        if ($this->collChildrens === null) {
            $this->initChildrens();
            $this->collChildrensPartial = true;
    ...
    /**
     * @param ChildKstruktur $children The ChildKstruktur object to add.
     */
    protected function doAddChildren(ChildKstruktur $children)
    {
    ...
    /**
     * @param  ChildKstruktur $children The ChildKstruktur object to remove.
     * @return $this|ChildKstruktur The current object (for fluent API support)
     */
    public function removeChildren(ChildKstruktur $children)
    {
    ...
    {
        if (null !== $this->aSkill) {
            $this->aSkill->removeKstruktur($this);
        }
        if (null !== $this->aParent) {
    ...
    {
        return (string) $this->exportTo(KstrukturTableMap::DEFAULT_STRING_FORMAT);
    }
