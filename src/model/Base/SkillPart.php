...
/**
 * Base class that represents a row from the 'kk_trixionary_skill_part' table.
 *
 *
 *
* @package    propel.generator..Base
*/
abstract class SkillPart implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\gossi\\trixionary\\model\\Map\\SkillPartTableMap';
     ...
     * @var        ChildSkill
     */
    protected $aSkillRelatedByPartId;

    /**
     * @var        ChildSkill
     */
    protected $aSkillRelatedByCompositeId;
    ...
    /**
     * Initializes internal state of gossi\trixionary\model\Base\SkillPart object.
     */
    ...
    /**
     * Compares this with another <code>SkillPart</code> instance.  If
     * <code>obj</code> is an instance of <code>SkillPart</code>, delegates to
     * <code>equals(SkillPart)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|SkillPart The current object, for fluid interface
     */
    ...
    public function setPartId($v)
    {
        ...
        if ($this->part_id !== $v) {
            $this->part_id = $v;
            $this->modifiedColumns[SkillPartTableMap::COL_PART_ID] = true;
        }

        if ($this->aSkillRelatedByPartId !== null && $this->aSkillRelatedByPartId->getId() !== $v) {
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            return $startcol + 2; // 2 = SkillPartTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\gossi\\trixionary\\model\\SkillPart'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildSkillPartQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see SkillPart::setDeleted()
     * @see SkillPart::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildSkillPartQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                SkillPartTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doSave(ConnectionInterface $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->aSkillRelatedByPartId !== null) {
                if ($this->aSkillRelatedByPartId->isModified() || $this->aSkillRelatedByPartId->isNew()) {
                    $affectedRows += $this->aSkillRelatedByPartId->save($con);
                }
                $this->setSkillRelatedByPartId($this->aSkillRelatedByPartId);
            }

            if ($this->aSkillRelatedByCompositeId !== null) {
                if ($this->aSkillRelatedByCompositeId->isModified() || $this->aSkillRelatedByCompositeId->isNew()) {
                    $affectedRows += $this->aSkillRelatedByCompositeId->save($con);
                }
                $this->setSkillRelatedByCompositeId($this->aSkillRelatedByCompositeId);
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $sql = sprintf(
            'INSERT INTO `kk_trixionary_skill_part` (%s) VALUES (%s)',
    ...
    {
        $pos = SkillPartTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['SkillPart'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        ...
        if ($includeForeignObjects) {
            if (null !== $this->aSkillRelatedByPartId) {
                ...
                $result[$key] = $this->aSkillRelatedByPartId->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
            if (null !== $this->aSkillRelatedByCompositeId) {
                ...
                $result[$key] = $this->aSkillRelatedByCompositeId->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
        }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\gossi\trixionary\model\SkillPart
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\gossi\trixionary\model\SkillPart The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \gossi\trixionary\model\SkillPart (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \gossi\trixionary\model\SkillPart Clone of current object.
     * @throws PropelException
     */
     ...
     * @throws PropelException
     */
    public function setSkillRelatedByPartId(ChildSkill $v = null)
    {
        if ($v === null) {
            $this->setPartId(NULL);
        } else {
     ...
     * @throws PropelException
     */
    public function getSkillRelatedByPartId(ConnectionInterface $con = null)
    {
        if ($this->aSkillRelatedByPartId === null && ($this->part_id !== null)) {
            $this->aSkillRelatedByPartId = ChildSkillQuery::create()->findPk($this->part_id, $con);
        ...
        return $this->aSkillRelatedByPartId;
    }
     ...
     * @throws PropelException
     */
    public function setSkillRelatedByCompositeId(ChildSkill $v = null)
    {
        if ($v === null) {
            $this->setCompositeId(NULL);
        } else {
            $this->setCompositeId($v->getId());
        }

        $this->aSkillRelatedByCompositeId = $v;
     ...
     * @throws PropelException
     */
    public function getSkillRelatedByCompositeId(ConnectionInterface $con = null)
    {
        if ($this->aSkillRelatedByCompositeId === null && ($this->composite_id !== null)) {
            $this->aSkillRelatedByCompositeId = ChildSkillQuery::create()->findPk($this->composite_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
        ...
        return $this->aSkillRelatedByCompositeId;
    }
    ...
    {
        return (string) $this->exportTo(SkillPartTableMap::DEFAULT_STRING_FORMAT);
    }
