...
/**
 * Base class that represents a row from the 'kk_trixionary_function' table.
 *
 *
 *
* @package    propel.generator..Base
*/
abstract class Function implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\gossi\\trixionary\\model\\Map\\FunctionTableMap';
    ...
    /**
     * @var        ObjectCollection|ChildFunction[] Collection to store aggregation of ChildFunction objects.
     */
     ...
     * @var ObjectCollection|ChildFunction[]
     */
    protected $childrensScheduledForDeletion = null;

    /**
     * Initializes internal state of gossi\trixionary\model\Base\Function object.
     */
    ...
    /**
     * Compares this with another <code>Function</code> instance.  If
     * <code>obj</code> is an instance of <code>Function</code>, delegates to
     * <code>equals(Function)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Function The current object, for fluid interface
     */
     ...
     * @return $this|\gossi\trixionary\model\Function The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[FunctionTableMap::COL_ID] = true;
        }
    ...
    public function setType($v)
    {
        ...
        if ($this->type !== $v) {
            $this->type = $v;
            $this->modifiedColumns[FunctionTableMap::COL_TYPE] = true;
        }
    ...
    public function setSkillId($v)
    {
        ...
        if ($this->skill_id !== $v) {
            $this->skill_id = $v;
            $this->modifiedColumns[FunctionTableMap::COL_SKILL_ID] = true;
        }
    ...
    public function setTitle($v)
    {
        ...
        if ($this->title !== $v) {
            $this->title = $v;
            $this->modifiedColumns[FunctionTableMap::COL_TITLE] = true;
        }
    ...
    public function setParentId($v)
    {
        ...
        if ($this->parent_id !== $v) {
            $this->parent_id = $v;
            $this->modifiedColumns[FunctionTableMap::COL_PARENT_ID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : FunctionTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : FunctionTableMap::translateFieldName('Type', TableMap::TYPE_PHPNAME, $indexType)];
            $this->type = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : FunctionTableMap::translateFieldName('SkillId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->skill_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : FunctionTableMap::translateFieldName('Title', TableMap::TYPE_PHPNAME, $indexType)];
            $this->title = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : FunctionTableMap::translateFieldName('ParentId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 5; // 5 = FunctionTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\gossi\\trixionary\\model\\Function'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildFunctionQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Function::setDeleted()
     * @see Function::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildFunctionQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                FunctionTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(FunctionTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(FunctionTableMap::COL_TYPE)) {
            $modifiedColumns[':p' . $index++]  = '`type`';
        }
        if ($this->isColumnModified(FunctionTableMap::COL_SKILL_ID)) {
            $modifiedColumns[':p' . $index++]  = '`skill_id`';
        }
        if ($this->isColumnModified(FunctionTableMap::COL_TITLE)) {
            $modifiedColumns[':p' . $index++]  = '`title`';
        }
        if ($this->isColumnModified(FunctionTableMap::COL_PARENT_ID)) {
            $modifiedColumns[':p' . $index++]  = '`parent_id`';
        }

        $sql = sprintf(
            'INSERT INTO `kk_trixionary_function` (%s) VALUES (%s)',
    ...
    {
        $pos = FunctionTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Function'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Function'][$this->hashCode()] = true;
        $keys = FunctionTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getType(),
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\gossi\trixionary\model\Function
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\gossi\trixionary\model\Function The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(FunctionTableMap::COL_ID)) {
            $criteria->add(FunctionTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(FunctionTableMap::COL_TYPE)) {
            $criteria->add(FunctionTableMap::COL_TYPE, $this->type);
        }
        if ($this->isColumnModified(FunctionTableMap::COL_SKILL_ID)) {
            $criteria->add(FunctionTableMap::COL_SKILL_ID, $this->skill_id);
        }
        if ($this->isColumnModified(FunctionTableMap::COL_TITLE)) {
            $criteria->add(FunctionTableMap::COL_TITLE, $this->title);
        }
        if ($this->isColumnModified(FunctionTableMap::COL_PARENT_ID)) {
            $criteria->add(FunctionTableMap::COL_PARENT_ID, $this->parent_id);
        }
    ...
    {
        $criteria = ChildFunctionQuery::create();
        $criteria->add(FunctionTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \gossi\trixionary\model\Function (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \gossi\trixionary\model\Function Clone of current object.
     * @throws PropelException
     */
    ...
    /**
     * Declares an association between this object and a ChildFunction object.
     *
     * @param  ChildFunction $v
     * @return $this|\gossi\trixionary\model\Function The current object (for fluent API support)
     * @throws PropelException
     */
    public function setParent(ChildFunction $v = null)
    {
        if ($v === null) {
        ...
        // Add binding for other direction of this n:n relationship.
        // If this object has already been added to the ChildFunction object, it will not be re-added.
        if ($v !== null) {
            $v->addChildren($this);
        }
    ...
    /**
     * Get the associated ChildFunction object
     *
     * @param  ConnectionInterface $con Optional Connection object.
     * @return ChildFunction The associated ChildFunction object.
     * @throws PropelException
     */
    public function getParent(ConnectionInterface $con = null)
    {
        if ($this->aParent === null && ($this->parent_id !== null)) {
            $this->aParent = ChildFunctionQuery::create()->findPk($this->parent_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
    ...
    public function initChildrens($overrideExisting = true)
    {
        ...
        $this->collChildrens->setModel('\gossi\trixionary\model\Function');
    }

    /**
     * Gets an array of ChildFunction objects which contain a foreign key that references this object.
     *
     * If the $criteria is not null, it is used to always fetch the results from the database.
     * Otherwise the results are fetched from the database the first time, then cached.
     * Next time the same method is called without $criteria, the cached collection is returned.
     * If this ChildFunction is new, it will return
     * an empty collection or the current collection; the criteria is ignored on a new object.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     * @return ObjectCollection|ChildFunction[] List of ChildFunction objects
     * @throws PropelException
     */
    public function getChildrens(Criteria $criteria = null, ConnectionInterface $con = null)
    {
        ...
        if (null === $this->collChildrens || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collChildrens) {
                ...
                $collChildrens = ChildFunctionQuery::create(null, $criteria)
                    ->filterByParent($this)
                    ->find($con);
    ...
    /**
     * Sets a collection of ChildFunction objects related by a one-to-many relationship
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildFunction The current object (for fluent API support)
     */
    public function setChildrens(Collection $childrens, ConnectionInterface $con = null)
    {
        /** @var ChildFunction[] $childrensToDelete */
    ...
    /**
     * Returns the number of related Function objects.
     *
     * @param      Criteria $criteria
     * @param      boolean $distinct
     * @param      ConnectionInterface $con
     * @return int             Count of related Function objects.
     * @throws PropelException
     */
    public function countChildrens(Criteria $criteria = null, $distinct = false, ConnectionInterface $con = null)
    {
        ...
        if (null === $this->collChildrens || null !== $criteria || $partial) {
            ...
            $query = ChildFunctionQuery::create(null, $criteria);
            if ($distinct) {
                $query->distinct();
            }
    ...
    /**
     * Method called to associate a ChildFunction object to this object
     * through the ChildFunction foreign key attribute.
     *
     * @param  ChildFunction $l ChildFunction
     * @return $this|\gossi\trixionary\model\Function The current object (for fluent API support)
     */
    public function addChildren(ChildFunction $l)
    {
        if ($this->collChildrens === null) {
            $this->initChildrens();
            $this->collChildrensPartial = true;
    ...
    /**
     * @param ChildFunction $children The ChildFunction object to add.
     */
    protected function doAddChildren(ChildFunction $children)
    {
    ...
    /**
     * @param  ChildFunction $children The ChildFunction object to remove.
     * @return $this|ChildFunction The current object (for fluent API support)
     */
    public function removeChildren(ChildFunction $children)
    {
     ...
     * Otherwise if this Function is new, it will return
     * an empty collection; or if this Function has previously
     * been saved, it will retrieve related Childrens from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Function.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
    ...
    {
        if (null !== $this->aSkill) {
            $this->aSkill->removeFunction($this);
        }
        if (null !== $this->aParent) {
    ...
    {
        return (string) $this->exportTo(FunctionTableMap::DEFAULT_STRING_FORMAT);
    }
