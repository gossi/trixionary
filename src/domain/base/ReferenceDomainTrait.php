...
trait ReferenceDomainTrait {
	...
	public function addVideos($id, $data) {
		...
		$dispatcher->dispatch(ReferenceEvent::PRE_VIDEOS_ADD, $event);
		$dispatcher->dispatch(ReferenceEvent::PRE_SAVE, $event);
		$rows = $model->save();
		$dispatcher->dispatch(ReferenceEvent::POST_VIDEOS_ADD, $event);
		$dispatcher->dispatch(ReferenceEvent::POST_SAVE, $event);
	...
	public function create($data) {
		...
		$event = new ReferenceEvent($model);
		$dispatcher = $this->getServiceContainer()->getDispatcher();
		$dispatcher->dispatch(ReferenceEvent::PRE_CREATE, $event);
		$dispatcher->dispatch(ReferenceEvent::PRE_SAVE, $event);
		$model->save();
		$dispatcher->dispatch(ReferenceEvent::POST_CREATE, $event);
		$dispatcher->dispatch(ReferenceEvent::POST_SAVE, $event);
	...
	public function delete($id) {
		...
		$event = new ReferenceEvent($model);
		$dispatcher = $this->getServiceContainer()->getDispatcher();
		$dispatcher->dispatch(ReferenceEvent::PRE_DELETE, $event);
		$model->delete();

		if ($model->isDeleted()) {
			$dispatcher->dispatch(ReferenceEvent::POST_DELETE, $event);
	...
	public function removeVideos($id, $data) {
		...
		$event = new ReferenceEvent($model);
		$dispatcher = $this->getServiceContainer()->getDispatcher();
		$dispatcher->dispatch(ReferenceEvent::PRE_VIDEOS_REMOVE, $event);
		$dispatcher->dispatch(ReferenceEvent::PRE_SAVE, $event);
		$rows = $model->save();
		$dispatcher->dispatch(ReferenceEvent::POST_VIDEOS_REMOVE, $event);
		$dispatcher->dispatch(ReferenceEvent::POST_SAVE, $event);
	...
	public function setSkillId($id, $relatedId) {
		...
		if ($model->getSkillId() !== $relatedId) {
			...
			$event = new ReferenceEvent($model);
			$dispatcher = $this->getServiceContainer()->getDispatcher();
			$dispatcher->dispatch(ReferenceEvent::PRE_SKILL_UPDATE, $event);
			$dispatcher->dispatch(ReferenceEvent::PRE_SAVE, $event);
			$model->save();
			$dispatcher->dispatch(ReferenceEvent::POST_SKILL_UPDATE, $event);
			$dispatcher->dispatch(ReferenceEvent::POST_SAVE, $event);
	...
	public function update($id, $data) {
		...
		$event = new ReferenceEvent($model);
		$dispatcher = $this->getServiceContainer()->getDispatcher();
		$dispatcher->dispatch(ReferenceEvent::PRE_UPDATE, $event);
		$dispatcher->dispatch(ReferenceEvent::PRE_SAVE, $event);
		$rows = $model->save();
		$dispatcher->dispatch(ReferenceEvent::POST_UPDATE, $event);
		$dispatcher->dispatch(ReferenceEvent::POST_SAVE, $event);
	...
	public function updateVideos($id, $data) {
		...
		$event = new ReferenceEvent($model);
		$dispatcher = $this->getServiceContainer()->getDispatcher();
		$dispatcher->dispatch(ReferenceEvent::PRE_VIDEOS_UPDATE, $event);
		$dispatcher->dispatch(ReferenceEvent::PRE_SAVE, $event);
		$rows = $model->save();
		$dispatcher->dispatch(ReferenceEvent::POST_VIDEOS_UPDATE, $event);
		$dispatcher->dispatch(ReferenceEvent::POST_SAVE, $event);
